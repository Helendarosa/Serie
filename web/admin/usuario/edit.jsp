            ...
            <div class="row">
                <div class="col-md-12 pr-md-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtNome" required class="form-control" placeholder="Usuario" value="${obj.nome}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 pr-md-1">
                    <div class="form-group">
                        ...
                        <input type="email" name="txtEmail" required class="form-control" placeholder="Usuario" value="${obj.email}">
                    </div>
                </div>
            </div>
            <div class="row">
